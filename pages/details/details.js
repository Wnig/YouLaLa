...
Page({
  ...
  onLoad: function (options) {
    ...
    if (options.id) {
      if (options.com) {
        ...
        let obj = JSON.parse(options.com);
        console.log('details page options.obj:::', obj);

        this.setData({ urlType: obj.urlType || 0, platFormUserId: obj.platFormUserId || '', appName: obj.appName});
      } else {
        this.setData({
  ...
  */
  ...
  getUser(res2) {
    ...
    let orderSource = '';
    let platuserid = '';
    if (this.data.platFormUserId) {
      orderSource = 2;
      platuserid = this.data.platFormUserId;
    } else {
      orderSource = 1;
      platuserid = '';
    };
    ...
    if (res2.userInfo != '' && res2.userInfo != null && res2.userInfo != undefined && res2.userInfo.sex != '') {
      ...
      wx.navigateTo({
        url: url + '?sku=' + JSON.stringify(this.data.skuInfo) + '&type=' + this.data.type + '&shopid=' + this.data.fansUserShopId + '&less=' + this.data.less + '&formid=' + this.data.userFormId + '&ordertype=' + orderSource + '&platuserid=' + platuserid,
      });
      this.setData({
      ...
      wx.navigateTo({
        url: '../login/login?page=' + page + '&sku=' + JSON.stringify(this.data.skuInfo) + '&type=' + this.data.type + '&shopid=' + this.data.fansUserShopId + '&less=' + this.data.less + '&formid=' + this.data.userFormId + '&ordertype=' + orderSource + '&platuserid=' + platuserid,
      });
      this.setData({
        is_first_action: true
      });
