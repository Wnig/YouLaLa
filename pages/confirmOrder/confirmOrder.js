...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      platFormUserId: options.platuserid,
    });
  ...
  orderData() {
    ...
    let fansUserId = app.globalData.userId;
    let platFormUserId = (this.data.ordertype == '2') ? this.data.platFormUserId : '';
    let orderSource = this.data.ordertype; //0、纯平台订单，1、纯商户订单，2、从平台跳转到商户下的订单
